...
We’re constantly exploring new ways to enhance our decentralized chat app. Our mission is to push the boundaries of what is possible in a serverless, peer-to-peer (P2P) environment. Today, we are excited to introduce a new experimental feature: File Sharing by QR Code. This feature is designed to complement our app's decentralized functionalities and offer a unique way to share data securely and privately.
